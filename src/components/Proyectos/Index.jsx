            ...
            projects.map((project, index) => 
              <div key={index} className="project">
                ...
                <div className="links">
                  ...
                  <a href={project.linkPage}style={{ color: `${modeDark ? "white" : "black"}`}} target="_blank" rel="noopener noreferrer">Ver</a>
                </div>
              </div>
            )
          }
      ...
      <div className="modal-project" onClick={closeModalProject}>
        <div className="content" style={{background: `${modeDark ? "rgba(31, 31, 31, .96)" : "rgba(243, 243, 243, .96)"}`}}>
          ...
          <div className="modal-buttons">
            ...
            <a href={dataProjectSelected.linkPage} style={{ color: `${modeDark ? "white" : "black"}`}} target="_blank" rel="noopener noreferrer">Ver</a>
          </div>
        </div>
        <div 
          className="close"
